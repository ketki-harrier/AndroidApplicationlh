...
package com.lifecyclehealth.lifecyclehealth.universal_video;
...
public class UniversalVideoView extends SurfaceView
    ...
    public void onOrientationChanged(int screenOrientation, OrientationDetector.Direction direction) {
        ...
        if (direction == OrientationDetector.Direction.PORTRAIT) {
            ...
            setFullscreen(false, ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
        } else if (direction == OrientationDetector.Direction.REVERSE_LANDSCAPE) {
            setFullscreen(false, ActivityInfo.SCREEN_ORIENTATION_REVERSE_LANDSCAPE);
        }/* else if (direction == OrientationDetector.Direction.LANDSCAPE) {
     ...
     */
    public void setVideoPath(String path,Context mContext) {
...
//                    }
    ...
    /**
     * Register a callback to be invoked when the media file_show
    ...
    /**
     * Register a callback to be invoked when the end of a media file_show
