package com.lifecyclehealth.lifecyclehealth.image;
...
/**
 * Created by vaibhavi on 02-10-2017.
 */
...
public class ChoosePhoto {
    ...
    public void showAlertDialog() {
        ...
        final Intent chooserIntent = Intent.createChooser(galleryIntent, mContext.getString(R.string.app_id));
