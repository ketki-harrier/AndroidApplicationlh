...
public class NotificationBuilder {
    ...
    public static class V1 {
        ...
        public V1 setIsRefresh(boolean value) {
            N.setIsRefresh(value);
            return this;
        }
