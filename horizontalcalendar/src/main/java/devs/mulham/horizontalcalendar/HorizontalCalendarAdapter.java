...
//            holder.layoutBackground.setBackgroundColor(Color.TRANSPARENT);
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            holder.layoutBackground.setBackground(ContextCompat.getDrawable(context, R.drawable.bg_text_view));
        } else {
            holder.layoutBackground.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.bg_text_view));
        }
